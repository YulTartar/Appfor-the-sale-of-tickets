...
class ContentShowTicket(MDBoxLayout):
    def edit_content(self, elem):
        self.ids.label_from_in.text = self.bd[elem]['from'] + " - " + self.bd[elem]['in']
        self.ids.label_date_time.text = self.bd[elem]['date_from'] + " " + self.bd[elem][
            'time_from'] + " - " + self.bd[elem]['date_in'] + " " + self.bd[elem]['time_in']
        self.ids.label_class.text = "Класс билета: " + self.bd[elem]['class_ticket']
        self.ids.label_airplane.text = "Модель самолёта: " + self.bd[elem]['airplane']
        self.ids.label_company.text = "Авиакомпания: " + self.bd[elem]['company']
        self.ids.label_price.text = "Цена билета: " + self.bd[elem]['price']
        self.ids.label_miles.text = "Цена в милях: " + self.bd[elem]['miles']
